...
public class Size {
    ...
    public static final Dimension GUI_SIZE = new Dimension(800,800);

    public static final Dimension SAVE_BUTTON = new Dimension(280,250);

    public static final Dimension JCOMBO_BOX = new Dimension(150,60);
